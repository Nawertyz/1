...
{
    public $email = "hoangcbqtks@gmail.com"; //email tài khoản cloudflade
    public $global_key = "9f1dfc575d43c58db8432c28c5a9b172d6929"; //api key lấy từ https://dash.cloudflare.com/profile/api-tokens
    public $account_id = "0e5b16907a75d6bc6f7c96a68ae9bba2"; // account id lấy click vào doamin rồi kéo xuống tìm acccount id
    public $token = "2Jv8qRMA9aijPXh1qccLDKTtzoNu1cThrqfD1RFD"; //tạo token từ https://dash.cloudflare.com/profile/api-tokens
    public $ip_host = "103.221.221.19"; // ip của hosting
