...
class RechargeTransfer extends Command
{
    ...
    public function handle()
    {
        ...
        if ($account) {
            ...
            if ($account->type == 'mbbank') {
               $ch = curl_init('https://thueapi.pro/historyapimbbank/'.$api_token);
    ...
    //  echo $response;
        $result = json_decode($response, true);
            ...
            elseif ($account->type == 'vietcombank') {
                $curl = curl_init();
                curl_setopt_array($curl, array(
                CURLOPT_URL => "https://thueapi.pro/historyapivcb/$api_token",
    ...
    //  echo $response;
        $result = json_decode($response, true);
            ...
            ->first();
                ...
                $curl = curl_init();
                curl_setopt_array($curl, array(
                CURLOPT_URL => "https://thueapi.pro/historyapiacb/$api_token",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_SSL_VERIFYPEER => false,
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 30,
            ...
            ->first();
                ...
                $curl = curl_init();
                curl_setopt_array($curl, array(
                CURLOPT_URL => "https://api.web2m.com/historyapimomo/$api_token",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_SSL_VERIFYPEER => false,
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 30,
