...
class Cronpfb extends Command 
{
     ...
     * @var string
     */
    protected $description = 'Cron service pfb';
    ...
    public function handle()
    {
        ...
        $this->info('Cron pfb: ' . date('d-m-Y H:i:s'));
        $data = Orders::where('actual_service', 'pfb')
        ...
        $this->info('Cron pfb: ' . $count . ' orders');
