                    ...
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            <div class="p-4 bg-primary rounded-2">
                                <i class="fas fa-users text-white fs-7"></i>
                            </div>
                            <div class="d-flex flex-column">
                                <div class=" fs-5 fw-bold">Tổng thành viên</div>
                ...
                <div class="d-flex align-items-center  rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class=" fs-5 fw-bold">Tổng cộng tác viên</div>
                                <span class="text-muted fw-normal"><b
                ...
                <div class="d-flex align-items-center  rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class=" fs-5 fw-bold">Tổng đại lý</div>
                                <span class="text-muted fw-normal"><b
                ...
                <div class="d-flex align-items-center  rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class=" fs-5 fw-bold">Tổng nhà phân phối</div>
                                <span class="text-muted fw-normal"><b
                ...
                <div class="d-flex align-items-center  rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class=" fs-5 fw-bold">Tổng số quản trị viên</div>
                                <span class="text-muted fw-normal"><b
