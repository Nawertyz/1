                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fa fa-star me-2 fs-4 "></i><span
                                                class=" ps-3">Họ và tên</span></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label><i class="fa fa-star me-2 fs-4 "></i><span
                                                class=" ps-3">Tài khoản</span></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
