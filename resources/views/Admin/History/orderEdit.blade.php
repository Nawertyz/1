                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.order.edit.post', $order->id) }}" method="POST" request="ptl">
                            ...
                            <select name="status" id="" class="form-select ">
                                ...
                                <option value="Refunded" @if ($order->status == 'Refunded') selected @endif>Đã hoàn</option>
                                    ...
                                    <option value="PendingOrder" @if ($order->status == 'PendingOrder') selected @endif>Chuẩn bị</option>
                                      <option value="Failed" @if ($order->status == 'Failed') selected @endif>Đơn lỗi</option>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label><i class="fa fa-star me-2 fs-4 "></i><span
                                    class=" ps-3">Bắt đầu</span></label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control " value="{{ $order->buff }}" name="buff" rows="5" placeholder="Name">
                            <label><i class="fa fa-star me-2 fs-4 "></i><span
                                    class=" ps-3">Đã chạy</span></label>
                        </div>
