                ...
                <div class="d-flex align-items-center bg-white rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class="text-dark fs-5 fw-bold">Tổng đơn hàng hoàn thành</div>
                                <span class="text-muted fw-normal"><b
                                        class="text-danger">{{ number_format($order_completed) }}</b></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center bg-white rounded p-3">
                    <div class="d-flex flex-stack">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <div class="text-dark fs-5 fw-bold">Tổng đơn hàng lỗi</div>
                                <span class="text-muted fw-normal"><b
                                        class="text-danger">{{ number_format($order_failed) }}</b></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        createDataTable('#history', '{{ route('admin.list', 'history-user-today') }}', [{
            ...
            
            {
                data: 'old_data',
                render: function(data){
                    return `<span class="badge bg-primary">`+formatNumber(parseInt(data))+`</span>`
                }
            },
            {
                data: 'data',
            ...
            },
            {
                data: 'new_data',
                render: function(data){
                    return `<span class="badge bg-success">`+formatNumber(parseInt(data))+`</span>`
                }
            },
            {
                data: 'description',
