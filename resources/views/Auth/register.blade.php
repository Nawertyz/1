    ...
    >
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div x-data="auth">
                ...
                <div
                    class="relative flex min-h-screen items-center justify-center bg-[url(/Lam-Tilo/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16"
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                ...
                                <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src="/Lam-Tilo/images/auth/register.svg" alt="Cover Image" class="w-full" />
                                </div>
                            </div>
                        </div>
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Đăng kí</h1>
                                    <p class="text-base font-bold leading-normal text-white-dark">Vui lòng nhập đầy đủ thông tin!</p>
                                </div>
                                <form class="space-y-5 dark:text-white"  action="{{ route('register.post') }}" method="POST">
                                @csrf
                                   <div>
                                        <label for="Username">Họ và tên</label>
                                        <div class="relative text-white-dark">
                                            <input name="name" type="text" placeholder="Enter name" class="form-input ps-10 placeholder:text-white-dark" />
                                ...
                                <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input name="email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark">
                                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input
                                                ...
                                                type="password"
                                                placeholder="Enter Password Confimation"
                                                class="form-input ps-10 placeholder:text-white-dark"
                                            />
                                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    ...
                                    <div>
                                    <div class="g-recaptcha" data-sitekey="{{ DataSite('site_key') }}"></div>
                                    </div>
                                    <div>
                                        <label class="flex cursor-pointer items-center">
                                            <input type="checkbox" class="form-checkbox bg-white dark:bg-black" />
                                            <span class="text-white-dark">Tôi đồng ý với điều khoản</span>
                                        </label>
                                    </div>
                                    <button
                                        type="submit"
