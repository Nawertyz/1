...
!function(t, e) {
    ...
    var y = {}
      , w = function(t) {
        return new Promise((function(e) {
            ...
            y.restoreFocusTimeout = setTimeout((function() {
                y.previousActiveElement instanceof HTMLElement ? (y.previousActiveElement.focus(),
                y.previousActiveElement = null) : document.body && document.body.focus(),
                e()
            }
            ), 100),
            window.scrollTo(n, o)
      ...
      , ot = function(t, n, o) {
        ...
        n.customClass && n.customClass[o]) {
            if ("string" != typeof n.customClass[o] && !n.customClass[o].forEach)
                return void B("Invalid type of customClass.".concat(o, '! Expected string or iterable object, got "').concat(e(n.customClass[o]), '"'));
      ...
      , st = function(t, e) {
        for (var n = Array.from(t.children), o = 0; o < n.length; o++) {
            var i = n[o];
            if (i instanceof HTMLElement && nt(i, e))
                return i
        }
    }
      , lt = function(t, e, n) {
      ...
      , kt = function(t) {
        var e, n = !!(e = I()) && (e.remove(),
        ut([document.documentElement, document.body], [A["no-backdrop"], A["toast-shown"], A["has-column"]]),
        !0);
        if (wt())
            T("SweetAlert2 requires document to initialize");
        else {
      ...
      , xt = function(t, e) {
        var n = Z()
          , o = Y();
        n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? dt(n) : ft(n),
        ot(n, e, "actions"),
        function(t, e, n) {
            var o = z()
              , i = K()
    ...
    var Ot = function(t, e) {
        ...
        function(t, e) {
            if (!e)
                return;
            e in A ? ct(t, A[e]) : (B('The "position" parameter is not valid, defaulting to "center"'),
            ct(t, A.center))
        }(n, e.position),
        function(t, e) {
            if (!e)
      ...
      , Mt = function(t) {
        if (t.input)
            if (_t[t.input]) {
                ...
                T("Unexpected type of input! Expected ".concat(Object.keys(_t).join(" | "), ', got "').concat(t.input, '"'))
    }
      , It = function(t, e) {
        var n = it(q(), t);
        if (n)
    ...
    _t.checkbox = function(t, e) {
        ...
        return et(o, e.inputPlaceholder),
        n
    }
    ,
    ...
    var Nt = function(t, e) {
        ...
        e.html ? (Et(e.html, n),
        dt(n, "block")) : e.text ? (n.textContent = e.text,
        dt(n, "block")) : ft(n),
        function(t, e) {
            var n = q();
            if (n) {
      ...
      , Yt = function(t, e) {
        ...
        e.toast ? (ct([document.documentElement, document.body], A["toast-shown"]),
        ct(t, A.toast)) : ct(t, A.modal),
        ot(t, e, "popup"),
      ...
      , Zt = function(t) {
        ...
        return ct(e, A["progress-step"]),
        et(e, t),
        e
    }
      , $t = function(t) {
        var e = document.createElement("li");
        return ct(e, A["progress-step-line"]),
            ...
            if (o) {
                ...
                if (e.icon || e.iconHtml) {
                    if (e.icon && -1 === Object.keys(k).indexOf(e.icon))
                        return T('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')),
                        void ft(o);
                    dt(o),
                    zt(o, e),
                    Ft(o, e),
      ...
      , oe = function(t, e, n) {
        ...
        "Enter" === e.key ? ie(e, t) : "Tab" === e.key ? re(e) : [].concat(ee, ne).includes(e.key) ? ae(e.key) : "Escape" === e.key && ce(e, t, n)))
    }
      , ie = function(t, e) {
      ...
      , ce = function(t, e, n) {
        O(e.allowEscapeKey) && (t.preventDefault(),
        n(Gt.esc))
    }
      , ue = {
      ...
      , he = null
      , ve = function(t) {
        null === he && (document.body.scrollHeight > window.innerHeight || "scroll" === t) && (he = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
        document.body.style.paddingRight = "".concat(he + function() {
            var t = document.createElement("div");
    ...
    function ge(t, e, n, o) {
        ...
        Qt(y)),
        le ? (e.setAttribute("style", "display:none !important"),
        e.removeAttribute("class"),
        e.innerHTML = "") : e.remove(),
        Q() && (null !== he && (document.body.style.paddingRight = "".concat(he, "px"),
        he = null),
        function() {
    ...
    function be(t) {
        ...
        var e = ue.swalPromiseResolve.get(this)
          , n = ye(this);
        this.isAwaitingPromise ? t.isDismissed || (Ce(this),
        e(t)) : n && e(t)
    }
    var ye = function(t) {
        var e = q();
        if (!e)
            return !1;
        var n = Lt.innerParams.get(t);
        if (!n || nt(e, n.hideClass.popup))
            return !1;
        ut(e, n.showClass.popup),
        ct(e, n.hideClass.popup);
        var o = I();
        return ut(o, n.showClass.backdrop),
    ...
    var Ce = function(t) {
      ...
      , ke = function(t, e, n) {
        ...
        i ? Ee(t, e, o, n.returnFocus, n.didClose) : ge(t, o, n.returnFocus, n.didClose)
    }
      , Ee = function(t, e, n, o, i) {
        Tt && (y.swalCloseEventFinishedCallback = ge.bind(null, t, n, o, i),
        e.addEventListener(Tt, (function(t) {
            t.target === e && (y.swalCloseEventFinishedCallback(),
      ...
      , Le = function(t, n) {
        ...
        if (o) {
            ...
            L(n.inputOptions) || M(n.inputOptions) ? (Be(z()),
      ...
      , je = function(t, e) {
        var n = t.getInput();
        n && (ft(n),
        j(e.inputValue).then((function(o) {
    ...
    var Me = function t(n) {
      ...
      , De = function(t, e) {
        ...
        if (n.input) {
            ...
            n.inputValidator ? qe(t, i, e) : o && !o.checkValidity() ? (t.enableButtons(),
            t.showValidationMessage(n.validationMessage)) : "deny" === e ? Ve(t, i) : Ne(t, i)
        } else
            T('The "input" parameter is needed to be set when using returnInputValueOn'.concat(P(e)))
    }
      , qe = function(t, e, n) {
        var o = Lt.innerParams.get(t);
        t.disableInput(),
        Promise.resolve().then((function() {
            ...
            t.enableButtons(),
            t.enableInput(),
            o ? t.showValidationMessage(o) : "deny" === n ? Ve(t, e) : Ne(t, e)
        }
        ))
    }
      , Ve = function(t, e) {
        var n = Lt.innerParams.get(t || He);
        (n.showLoaderOnDeny && Be(K()),
      ...
      , Ne = function(t, e) {
        ...
        Promise.resolve().then((function() {
            ...
            vt(U()) || !1 === n ? (t.hideLoading(),
            Ce(t)) : Re(t, void 0 === n ? e : n)
        }
        )).catch((function(e) {
            return _e(t || He, e)
        }
    ...
    function Ke(t, e) {
        ...
        if (n && t)
            if ("radio" === t.type)
                for (var o = n.querySelectorAll('[name="'.concat(A.radio, '"]')), i = 0; i < o.length; i++)
                    o[i].disabled = e;
            else
                t.disabled = e
    }
    ...
    function fn() {
        ...
        e ? (t.popup && y.swalCloseEventFinishedCallback && (y.swalCloseEventFinishedCallback(),
        delete y.swalCloseEventFinishedCallback),
    ...
    var pn = function(t) {
      ...
      , mn = function(t) {
        t.isAwaitingPromise ? (hn(Lt, t),
        t.isAwaitingPromise = !0) : (hn(ue, t),
        hn(Lt, t),
    ...
    var xn, Sn = function(t) {
        ...
        bindClickHandler: function() {
            ...
            Bn || (document.body.addEventListener("click", Sn),
            Bn = !0)
        },
        ...
        return n && (Nn(n, ["src", "width", "height", "alt"]),
        ...
        n && (Nn(n, ["type", "label", "placeholder", "value"]),
        ...
        Q() && (Wn(e, t.scrollbarPadding, o),
        Array.from(document.body.children).forEach((function(t) {
            t === I() || t.contains(I()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden") || ""),
        ...
        if (e.target === n && Tt) {
            var o = I();
            n.removeEventListener(Tt, t),
            o.style.overflowY = "auto"
        }
    }, zn = function(t, e) {
        Tt && bt(e) ? (t.style.overflowY = "hidden",
        e.addEventListener(Tt, Un)) : t.style.overflowY = "auto"
    }, Wn = function(t, e, n) {
        !function() {
    ...
    function Zn(t) {
        !function(t) {
            t.inputValidator || ("email" === t.input && (t.inputValidator = Yn.email),
    ...
    var $n = new WeakMap
      ...
      , Xn = function(t, e, n) {
        return new Promise((function(o, i) {
            ...
            function(t, e) {
                ...
                )) && (L(e.inputValue) || M(e.inputValue)) && (Be(z()),
                je(t, e))
            }(t, n),
            Fn(n),
            to(y, n, r),
      ...
      , Gn = function(t, e) {
        ...
        return o.showClass = Object.assign({}, Qe.showClass, o.showClass),
      ...
      , Qn = function(t) {
        ...
        return Lt.domCache.set(t, e),
        e
    }
      , to = function(t, e, n) {
        var o = J();
        ft(o),
        e.timer && (t.timeout = new Ln((function() {
            n("timer"),
            delete t.timeout
        }
        ),e.timer),
        e.timerProgressBar && (dt(o),
